...
function _tk_scripts()
{
  ...
  // load ghost js
  wp_enqueue_script('_ghost', get_template_directory_uri() . '/includes/js/ghost.js', false);
  wp_enqueue_script('_ghost-plugin', get_template_directory_uri() . '/includes/js/ghost.plugin.js', array('_ghost'));
}
